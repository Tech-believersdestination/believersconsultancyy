        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            ...
            <div className="text-center p-6 bg-blue-50 rounded-2xl border border-blue-200">
              ...
              <h3 className="font-bold text-blue-800 mb-2">Secure</h3>
              <p className="text-blue-700 text-sm">Your data is encrypted and protected</p>
            </div>
            <div className="text-center p-6 bg-purple-50 rounded-2xl border border-purple-200">
              <Users className="w-12 h-12 text-purple-600 mx-auto mb-4" />
              <h3 className="font-bold text-purple-800 mb-2">Confidential</h3>
              <p className="text-purple-700 text-sm">Never shared without consent</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="text-center bg-gradient-to-br from-orange-50 to-red-50 rounded-3xl p-12">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <div className="flex items-center bg-blue-100 text-blue-800 px-6 py-3 rounded-full font-semibold">
                ...
                <span>privacy@believersconsultancy.com</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="border-t border-gray-800 mt-8 pt-6">
            <p className="text-gray-400 text-sm">
              © 2025 Believers Destination. All rights reserved. | Committed to your privacy and success.
            </p>
          </div>
        </div>
      </footer>
